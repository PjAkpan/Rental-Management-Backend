...
function appendToFile(modelsPath, modelTypes) {
    return __awaiter(this, void 0, void 0, function () {
        var filePath, existingContent, err_2, findInfoParamsExists, newContent, updatedContent, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 7, , 8]);
                ...
                case 1:
                    // Ensure the directory exists
                    _a.sent();
                    filePath = path.join(modelsPath, modelTypes.name);
                    existingContent = "";
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                ...
                case 4:
                    ...
                    if (err_2.code !== "ENOENT")
                        throw err_2; // Ignore file-not-found errors
                    return [3 /*break*/, 5];
                case 5:
                    findInfoParamsExists = existingContent.includes("export type FindInfoParams");
                    newContent = modelTypes.content;
                ...
                case 7:
                    err_3 = _a.sent();
                    console.error("Error appending content:", err_3);
                    return [3 /*break*/, 8];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    ...
                    //   modelTypes.content,
                    // );
                    return [4 /*yield*/, appendToFile(modelsPath, modelTypes)];
                case 8:
                    // await fs.writeFile(
                    //   path.join(modelsPath, modelTypes.name),
                    //   modelTypes.content,
